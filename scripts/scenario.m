        ...
        otherwise
            if not(isnumeric(A))
                ...
                elseif predefined == 20
                    ...
                    Agent(1) = struct('name', 'Agent_1', 'type', 1, 'Ft', 20*60, 'Ft_0', 0*60, 'ts', 5, 'P0', struct('x', 1, 'y', 1, 'z', 0));
                    Agent(2) = struct('name', 'Agent_2', 'type', 1, 'Ft', 20*60, 'Ft_0', 0*60, 'ts', 5, 'P0', struct('x', 1, 'y', 1, 'z', 0));
                    Agent(3) = struct('name', 'Agent_3', 'type', 1, 'Ft', 20*60, 'Ft_0', 0*60, 'ts', 5, 'P0', struct('x', 1, 'y', 1, 'z', 0));
                    Agent(4) = struct('name', 'Agent_4', 'type', 1, 'Ft', 20*60, 'Ft_0', 0*60, 'ts', 5, 'P0', struct('x', 1, 'y', 1, 'z', 0));
                ...
                elseif predefined == 21
                    ...
                    Agent(1) = struct('name', 'Agent_1', 'type', 1, 'Ft', 20*60, 'Ft_0', 15*60, 'ts', 5, 'P0', struct('x', 1, 'y', 1, 'z', 0));
                    Agent(2) = struct('name', 'Agent_2', 'type', 1, 'Ft', 20*60, 'Ft_0',  0*60, 'ts', 5, 'P0', struct('x', 1, 'y', 1, 'z', 0));
                    Agent(3) = struct('name', 'Agent_3', 'type', 1, 'Ft', 20*60, 'Ft_0',  0*60, 'ts', 5, 'P0', struct('x', 1, 'y', 1, 'z', 0));
                    Agent(4) = struct('name', 'Agent_4', 'type', 1, 'Ft', 20*60, 'Ft_0',  0*60, 'ts', 5, 'P0', struct('x', 1, 'y', 1, 'z', 0));
                ...
                elseif predefined == 23
                    ...
                    Agent(1) = struct('name', 'Agent_1', 'type', 1, 'Ft', 10*60, 'Ft_0', 0*60, 'ts', 5, 'P0', struct('x', 1, 'y', 1, 'z', 0));
                    Agent(2) = struct('name', 'Agent_2', 'type', 1, 'Ft', 10*60, 'Ft_0', 5*60, 'ts', 5, 'P0', struct('x', 1, 'y', 1, 'z', 0));
                    ...
                    Agent(2) = struct('name', 'Agent_2', 'type', 2, 'Ft', 25*60, 'Ft_0', 5*60, 'ts', 5, 'P0', struct('x', 1, 'y', 1, 'z', 0));
